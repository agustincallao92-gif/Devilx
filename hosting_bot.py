...
#
#  Requirements:
#    pip install python-telegram-bot psutil openai
#
#  Setup:
...
OPENAI_API_KEY = "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"       # from platform.openai.com
...
async def handle_cb(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("genkey|"):
        ...
        if key:
            ...
            deep_link = f"https://t.me/{(await query.bot.get_me()).username}?start={key}"
            await query.message.reply_text(
